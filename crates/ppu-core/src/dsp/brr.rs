...
//
// BRR (Bit Rate Reduction) block decoder: 9 bytes in (1 header + 8 nibble
// bytes) -> 16 i16 samples out, using one of the four SNES prediction filters.
...
impl BrrBlockDecoder {
    pub(crate) fn new() -> BrrBlockDecoder {
    ...
    pub(crate) fn reset(&mut self, last_sample: i16, last_last_sample: i16) {
    ...
    pub(crate) fn read_next_sample(&mut self) -> i16 {
