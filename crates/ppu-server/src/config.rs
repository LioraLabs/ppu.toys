    ...
    pub fn from_map(get: impl Fn(&str) -> Option<String>) -> Self {
        ...
        Config {
            ...
            admin_ids: get("PPU_ADMIN_DISCORD_IDS")
                ...
                .unwrap_or_default(),
            session_ttl_days: get("PPU_SESSION_TTL_DAYS")
