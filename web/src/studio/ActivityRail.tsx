...
export interface ActivityRailProps {
  ...
  active?: RailItemId;
  /** Rail action registration point — the sketch-store ticket hangs the library
   *  panel off "files"; later tickets claim the rest. No-op when absent. */
...
export function ActivityRail({ active = "layers", onSelect }: ActivityRailProps) {
  return (
    <nav className="rail">
      <RailItem id="files" label="Files" active={active === "files"} onSelect={onSelect}>
