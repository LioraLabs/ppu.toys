...
const GLOBALS: Completion[] = [
  ...
  { label: "force_blank", type: "variable", detail: "bool · INIDISP.7 $2100" },
  {
    label: "bg",
    type: "variable",
    detail: "bg[1..4] layers — scroll/map/char_base/tile_size/mosaic…",
  },
  { label: "m7", type: "variable", detail: "Mode 7 .a .b .c .d .cx .cy .extbg · $211A-$2120" },
  {
    label: "color",
    type: "variable",
    detail: "color math .op .half .on .addend .region .fixed · CGWSEL/CGADSUB/COLDATA $2130-$2132",
  },
  {
    label: "screen",
    type: "variable",
    detail: "screen designation .main .sub (.bg1..bg4 .obj) · TM/TS $212C-$212D",
  },
  {
    label: "win",
    type: "variable",
  ...
  { label: "scanline", type: "function", detail: "alias of hdma · HDMA" },
  {
    label: "m7pixel",
    type: "function",
    detail: "m7pixel(tile,x,y,index) Mode 7 char pixel (8bpp)",
  },
  ...
  { label: "init", type: "function", detail: "init() — optional one-time setup" },
  {
    label: "apply_pokes",
    type: "function",
    detail: "apply_pokes() — inspector pokes (generated pokes.lua)",
  },
  ...
  ...["sin", "cos", "tan", "floor", "ceil", "abs", "min", "max", "sqrt"].map((n): Completion => ({
    label: n,
    type: "function",
    detail: "math global",
  })),
...
const MATH_MEMBERS: Completion[] = [
  ...
  label: n,
  type: n === "pi" || n === "huge" ? "constant" : "function",
}));
...
const BG_MEMBERS: Completion[] = [
  ...
  { label: "screen_size", type: "property", detail: "0..3 (32x32..64x64) · BGnSC" },
  {
    label: "char_base",
    type: "property",
    detail: "char VRAM word addr · BG12NBA/BG34NBA $210B/$210C",
  },
...
const OBJ_MEMBERS: Completion[] = [
  ...
  { label: "size_sel", type: "property", detail: "size pair 0..7 (small/large WxH) · OBSEL $2101" },
  {
    label: "name_select",
    type: "property",
    detail: "name-select 0..3 (2nd table gap) · OBSEL $2101",
  },
  ...
  { label: "oam_addr", type: "property", detail: "priority-rotation base sprite · OAMADD $2102" },
  {
    label: "first",
    type: "property",
    detail: "sugar: rotate priority from sprite N · OAMADD $2102",
  },
];
...
const M7_MEMBERS: Completion[] = [
  ...
  { label: "flip_y", type: "property", detail: "flip plane vertically · M7SEL $211A" },
  {
    label: "extbg",
    type: "property",
    detail: "Mode 7 per-pixel priority (EXTBG) · SETINI.6 $2133",
  },
...
const COLOR_MEMBERS: Completion[] = [
  ...
  { label: "half", type: "property", detail: "bool half result · CGADSUB.6 $2131" },
  {
    label: "on",
    type: "property",
    detail: ".bg1..bg4 .obj .backdrop math enables · CGADSUB.0-5 $2131",
  },
  { label: "addend", type: "property", detail: '"sub"|"fixed" math addend · CGWSEL.1 $2130' },
  {
    label: "region",
    type: "property",
    detail: '"everywhere"|"inside"|"outside"|"never" · CGWSEL.4-5 $2130',
  },
...
const WIN_MEMBERS: Completion[] = [
  ...
  { label: "w2", type: "property", detail: ".lo/.hi window 2 edges · WH2/WH3 $2128-$2129" },
  {
    label: "bg1",
    type: "property",
    detail: ".w1 .w2 .invert .combine .main .sub · W12SEL/WBGLOG/TMW/TSW",
  },
  {
    label: "bg2",
    type: "property",
  ...
  },
  {
    label: "bg3",
    type: "property",
    detail: ".w1 .w2 .invert .combine .main .sub · W34SEL/WBGLOG/TMW/TSW",
  },
  {
    label: "bg4",
    type: "property",
  ...
  },
  {
    label: "obj",
    type: "property",
    detail: ".w1 .w2 .invert .combine .main .sub · WOBJSEL/WOBJLOG/TMW/TSW",
  },
  {
    label: "color",
    type: "property",
    detail: ".w1 .w2 .invert .combine (no main/sub) · WOBJSEL/WOBJLOG",
  },
];
...
const WIN_LAYER_MEMBERS: Completion[] = [
  ...
  { label: "invert", type: "property", detail: "bool invert both windows · SEL nibble bits 0/2" },
  {
    label: "combine",
    type: "property",
    detail: '"OR"|"AND"|"XOR"|"XNOR" · WBGLOG/WOBJLOG $212A-$212B',
  },
  {
    label: "main",
    type: "property",
    detail: "bool main-screen mask enable · TMW $212E (BG/OBJ only)",
  },
  {
    label: "sub",
    type: "property",
    detail: "bool sub-screen mask enable · TSW $212F (BG/OBJ only)",
  },
];
