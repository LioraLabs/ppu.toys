...
export default {
  title: "Studio/Inspector/Tracemem/TraceChain",
} satisfies StoryDefault;

export const PlaneSegStory: Story = () => <PlaneSeg />;
PlaneSegStory.storyName = "PlaneSeg";

export const ModeBadgeStory: Story = () => <ModeBadge frame={frameResult} />;
ModeBadgeStory.storyName = "ModeBadge";

export const TraceCaptionStory: Story = () => <TraceCaption frame={frameResult} />;
...
export const ResolutionChainRequiresCore: Story = () => <ResolutionChainNote />;
