...
export default {
  title: "Studio/Inspector/RegistersTab",
} satisfies StoryDefault;

export const Default: Story = () => <RegistersTab frame={frameResult} />;

export const Waiting: Story = () => <RegistersTab frame={null} />;
...
export const ViaInspectorFrameSeam: Story = () => (
